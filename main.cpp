...
void check_host(unsigned char* data){
    ...
    char* http = (char*)(data + iphdr_len + tcphdr_len);
    char* host = strstr(http, "Host: ");
    if(host == NULL){
        chk = 0;
        return;
    }
